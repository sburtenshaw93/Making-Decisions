...
if (amysAge > brittanisAge) {
  console.log(" Brittanis is younger than Amy")
...
if (amysBirthYear > brittanisBirthYear) {
  console.log("Brittanis was born first")
} else if (brittanisBirthYear > amysBirthYear) {
  console.log("Amy was born first")
} else {
  console.log("Amy and Brittanis are the same age")
};
////////// PROBLEM 4 //////////
...
if (temperature > 80 && raining) {
  ...
  console.log("Wear a rain jacket today!")
} else if (temperature < 60 && raining) {
  console.log("Wear a jacket and carry an umbrella")
} else if (temperature > 80 && sunny) {
  console.log(" Wear a t-shirt and shorts")
} else if (temperture > 60 && sunny){
  console.log("Wear a light jacket")
} else {
  console.log("Wear a jacket and long paints")
};
////////// PROBLEM 5 //////////
